...
fun manipulateString(str: String, int: Int): String {
    ...
    val multiplier = if (numberInString.isNotEmpty()) numberInString.toInt() else 1

    val result = if (numberInString.isNotEmpty()) {
        str.replace(numberInString, "") + (multiplier * int)
    } else {
        str + int
    }
